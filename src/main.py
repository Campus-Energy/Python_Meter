...
def main():
    ...
    data_test = POST_CHILLER_PLANT_MAIN.getData()
    register_dict = POST_CHILLER_PLANT_MAIN.dataConversion(data_dict=data_test)
    csvAdd.add_to_csv("E:\\MeterDataTest\\POST_CHILLER_PLANT_MAIN.csv",register_dict)

    data_test = POST_MAIN_1.getData()
    register_dict = POST_MAIN_1.dataConversion(data_dict=data_test)
    csvAdd.add_to_csv("E:\\MeterDataTest\\POST_MAIN_1.csv",register_dict)

    data_test = POST_MAIN_2.getData()
    register_dict = POST_MAIN_2.dataConversion(data_dict=data_test)
    csvAdd.add_to_csv("E:\\MeterDataTest\\POST_MAIN_2.csv",register_dict)
